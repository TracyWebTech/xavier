...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'ClassSubjectTime', fields ['class_subject', 'weekday', 'time']
        db.create_unique(u'timetables_classsubjecttime', ['class_subject_id', 'weekday', 'time_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ClassSubjectTime', fields ['class_subject', 'weekday', 'time']
        db.delete_unique(u'timetables_classsubjecttime', ['class_subject_id', 'weekday', 'time_id'])
    ...
    models = {
        ...
        u'timetables.classsubjecttime': {
            'Meta': {'unique_together': "(('class_subject', 'weekday', 'time'),)", 'object_name': 'ClassSubjectTime'},
