...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Score.class_subject'
        db.delete_column(u'scores_score', 'class_subject_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Score.class_subject'
        raise RuntimeError("Cannot reverse this migration. 'Score.class_subject' and its values cannot be restored.")
