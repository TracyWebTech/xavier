...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Score', fields ['subperiod', 'student', 'criteria']
        db.create_unique(u'scores_score', ['subperiod_id', 'student_id', 'criteria_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Score', fields ['subperiod', 'student', 'criteria']
        db.delete_unique(u'scores_score', ['subperiod_id', 'student_id', 'criteria_id'])
