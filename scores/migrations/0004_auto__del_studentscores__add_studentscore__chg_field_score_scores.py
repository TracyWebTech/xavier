...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'StudentScore'
        db.create_table(u'scores_studentscore', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('score', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'scores', ['StudentScore'])


        # Changing field 'Score.scores'
        db.alter_column(u'scores_score', 'scores_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scores.StudentScore']))
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'StudentScore'
        db.delete_table(u'scores_studentscore')


        # Changing field 'Score.scores'
        db.alter_column(u'scores_score', 'scores_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scores.StudentScores']))
    ...
    models = {
        ...
        u'scores.score': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'scores': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'student_score'", 'to': u"orm['scores.StudentScore']"}),
        ...
        u'scores.studentscore': {
            'Meta': {'object_name': 'StudentScore'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
