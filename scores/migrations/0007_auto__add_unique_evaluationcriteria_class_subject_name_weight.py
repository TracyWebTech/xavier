...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'EvaluationCriteria', fields ['class_subject', 'name', 'weight']
        db.create_unique(u'scores_evaluationcriteria', ['class_subject_id', 'name', 'weight'])


    def backwards(self, orm):
        # Removing unique constraint on 'EvaluationCriteria', fields ['class_subject', 'name', 'weight']
        db.delete_unique(u'scores_evaluationcriteria', ['class_subject_id', 'name', 'weight'])
