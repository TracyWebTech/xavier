...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ClassSubject', fields ['slug']
        db.create_unique(u'classes_classsubject', ['slug'])
        ...
        # Adding unique constraint on 'Grade', fields ['grade_type', 'name']
        db.create_unique(u'classes_grade', ['grade_type', 'name'])

        # Adding unique constraint on 'Class', fields ['slug']
        db.create_unique(u'classes_class', ['slug'])

        # Adding unique constraint on 'Class', fields ['grade', 'identification', 'period']
        db.create_unique(u'classes_class', ['grade_id', 'identification', 'period_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Class', fields ['grade', 'identification', 'period']
        db.delete_unique(u'classes_class', ['grade_id', 'identification', 'period_id'])

        # Removing unique constraint on 'Class', fields ['slug']
        db.delete_unique(u'classes_class', ['slug'])

        # Removing unique constraint on 'Grade', fields ['grade_type', 'name']
        db.delete_unique(u'classes_grade', ['grade_type', 'name'])
        ...
        # Removing unique constraint on 'ClassSubject', fields ['slug']
        db.delete_unique(u'classes_classsubject', ['slug'])
    ...
    models = {
        ...
        u'classes.class': {
            'Meta': {'unique_together': "(('identification', 'period', 'grade'),)", 'object_name': 'Class'},
        ...
        u'classes.grade': {
            'Meta': {'unique_together': "(('name', 'grade_type'),)", 'object_name': 'Grade'},
