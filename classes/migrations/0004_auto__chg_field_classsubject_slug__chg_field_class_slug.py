...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ClassSubject.slug'
        db.alter_column(u'classes_classsubject', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=70, null=True))

        # Changing field 'Class.slug'
        db.alter_column(u'classes_class', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=70, null=True))

    def backwards(self, orm):

        # Changing field 'ClassSubject.slug'
        db.alter_column(u'classes_classsubject', 'slug', self.gf('django.db.models.fields.SlugField')(default='', max_length=70))

        # Changing field 'Class.slug'
        db.alter_column(u'classes_class', 'slug', self.gf('django.db.models.fields.SlugField')(default='', max_length=70))
    ...
    models = {
        ...
        u'classes.class': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '70', 'null': 'True'}),
