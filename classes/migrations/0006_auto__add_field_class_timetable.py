...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Class.timetable'
        db.add_column(u'classes_class', 'timetable',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['timetables.Timetable']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Class.timetable'
        db.delete_column(u'classes_class', 'timetable_id')
