...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Class.timetable'
        db.alter_column(u'classes_class', 'timetable_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['timetables.Timetable'], null=True))

    def backwards(self, orm):

        # Changing field 'Class.timetable'
        db.alter_column(u'classes_class', 'timetable_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['timetables.Timetable']))
