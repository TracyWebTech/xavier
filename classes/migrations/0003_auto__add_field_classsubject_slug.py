...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClassSubject.slug'
        db.add_column(u'classes_classsubject', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=70),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClassSubject.slug'
        db.delete_column(u'classes_classsubject', 'slug')
