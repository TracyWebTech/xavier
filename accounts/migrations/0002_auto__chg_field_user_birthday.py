...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'accounts_user', 'birthday', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'User.birthday'
        db.alter_column(u'accounts_user', 'birthday', self.gf('django.db.models.fields.DateField')(default=2011))
