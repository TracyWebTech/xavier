...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'attendances_attendance', 'status',
                      self.gf('django.db.models.fields.CharField')(default='present', max_length=8),
                      keep_default=False)

        # Adding field 'Attendance.explanation'
        db.add_column(u'attendances_attendance', 'explanation',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'attendances_attendance', 'status')

        # Deleting field 'Attendance.explanation'
        db.delete_column(u'attendances_attendance', 'explanation')
